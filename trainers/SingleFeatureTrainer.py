...
class SingleFeatureModelTrainer:
    ...
    def __init__(self, feature_enum, num_epochs=100, batch_size=32, count_first_layer=16, count_second_layer=32,
                 ...
                 comet_project_name="MultiOutputNormedAuto", checkpoint_name=None, cuda_support=False,
                 vst_parameter=None):
    ...
    def startExperiment(self):
        ...
        elif self.feature_name.name == FeatureEnums.stft.name:
            self.features = DataGrabber.getStft()
